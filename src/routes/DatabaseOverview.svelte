...
<div class="flex gap-6 md:w-8/12">
	...
	<div class="flex w-full flex-col">
		...
		<div class="flex gap-6">
			<div class="mt-6 w-full rounded border border-gray-300 dark:border-gray-800 p-6">
			...
			<div class="mt-6 w-full rounded border border-gray-300 dark:border-gray-800 p-6">
				...
				<span class="mt-1 block text-gray-500 dark:text-gray-400">Contact the instance owner for support</span>
